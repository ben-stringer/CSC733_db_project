...
public class PaymentTransaction implements Tx {

    private final RandomDataGenerator rdg;
    private final int wId = 1;
    private final int dId;
    private final double hAmount;
    private final Function<Transaction, Node> customerQuery;

    public PaymentTransaction(final RandomDataGenerator _rdg) {
        rdg = _rdg;
        dId = rdg.rand().nextInt(10);
        hAmount = rdg.rand().nextDouble() * 5000;
    ...
    public void run(final Transaction tx) {
        ...
        System.out.format("Completed payment, amount is %f.\n", hAmount);
