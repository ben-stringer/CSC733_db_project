...
public class OrderStatusTransaction implements Tx {
    ...
    public OrderStatusTransaction(final RandomDataGenerator _rdg) {
        rdg = _rdg;
    ...
    public void run(final Transaction tx) {
        ...
        System.out.format("Checked the status of %d items in an order.", orderLineItems.size());
